	...
	return (
		<section className="h-full rounded-[22px] border border-border bg-card p-6">
			<header className="mb-5 flex items-center justify-between">
				<div>
					<h2 className="font-semibold text-lg">Pessoas que te devem</h2>
					<p className="text-muted-foreground text-sm">Valores em aberto</p>
				</div>
					...
					{people.map((person) => (
						...
						>
							<div className="min-w-0">
								...
								<p className="text-muted-foreground text-sm">
									{person.debtCount}{" "}
									{person.debtCount === 1 ? "registro" : "registros"}
								</p>
							</div>
							<span className="shrink-0 font-semibold text-sm sm:text-base">
